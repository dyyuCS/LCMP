...
if __name__ == '__main__':
    ...
    parser.add_argument('-o', dest='output', action='store', default='server-output/Figure9-posCor_8DC_differDataset', help="output file")
    ...
    # DATASET = ['WebSearch']
    DATASET = ['WebSearch', 'AliStorage', 'FbHdp']
