...
def modify_config(config_path, output_dir, routing_mode, x_util, cc_mode, dataset):
    ...
    for line in lines:
        if line.strip().startswith('ROUTING_MODE'):
            ...
            new_lines.append('FLOW_FILE ${WORKING_DIR}traffic_%s_8DC-%s.txt\n' % (dataset, x_util))
...
if __name__ == '__main__':
    ...
    parser.add_argument('-o', dest='output', action='store', default='server-output/Figure5-8DC_3routing_3traffic', help="output file")
