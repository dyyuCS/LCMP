...
const uint64_t IntHop::lineRateValues[8] = {25000000000lu,40000000000lu,50000000000lu,100000000000lu,200000000000lu,400000000000lu,600000000000lu,800000000000lu};
