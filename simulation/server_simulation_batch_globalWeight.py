...
def modify_config(config_path, output_dir_base, topology, alpha, beta):
    ...
    params = {
        ...
        'ROUTING_MODE': 2,
        'CC_MODE': 1,
        'OUTPUT_DIR': '{}/{}/alpha={}-beta={}/'.format(base_dir, output_dir_base, alpha, beta),
...
if __name__ == '__main__':
    ...
    parser.add_argument('-o', dest='output', action='store', default='server-output/global-weight', help="output file base directory")
